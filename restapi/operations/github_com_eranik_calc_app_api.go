...
func NewGithubComEranikCalcAppAPI(spec *loads.Document) *GithubComEranikCalcAppAPI {
	return &GithubComEranikCalcAppAPI{
		...
		MathAddHandler: math.AddHandlerFunc(func(params math.AddParams, principal *models.Principal) middleware.Responder {
			return middleware.NotImplemented("operation math.Add has not yet been implemented")
		}),
		MathSubtractHandler: math.SubtractHandlerFunc(func(params math.SubtractParams, principal *models.Principal) middleware.Responder {
			return middleware.NotImplemented("operation math.Subtract has not yet been implemented")
		}),
...
type GithubComEranikCalcAppAPI struct {
	...
	// MathAddHandler sets the operation handler for the add operation
	MathAddHandler math.AddHandler
	// MathSubtractHandler sets the operation handler for the subtract operation
	MathSubtractHandler math.SubtractHandler
...
func (o *GithubComEranikCalcAppAPI) Validate() error {
	...
	if o.MathAddHandler == nil {
		unregistered = append(unregistered, "math.AddHandler")
	}
	if o.MathSubtractHandler == nil {
		unregistered = append(unregistered, "math.SubtractHandler")
	}
...
func (o *GithubComEranikCalcAppAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/add"] = math.NewAdd(o.context, o.MathAddHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/subtract"] = math.NewSubtract(o.context, o.MathSubtractHandler)
}
